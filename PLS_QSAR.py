...
forthLabelTabThree=Label(tab1, text='%CV incremenet',font=("Helvetica", 12))
forthLabelTabThree.place(x=170,y=135)
forthEntryTabThree=Entry(tab1)
forthEntryTabThree.place(x=300,y=138)
